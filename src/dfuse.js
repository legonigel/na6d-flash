/*!
 * webdfu - WebUSB DFU/DfuSe Library (dfuse.js extension)
 * Copyright (c) 2016, Devan Lai
 * Copyright (c) 2025-2026, Nigel Armstrong (modifications)
 *
...
(function () {
  ...
  dfuse.Device = function (device, settings) {
    ...
    if (!name) {
      ...
      this.warning =
        'Device did not provide an interface name descriptor. Falling back to default STM32 memory layout.';
